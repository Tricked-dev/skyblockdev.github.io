...
export default function Home() {
  ...
  return (
    <section>
      <Head>
        <title>Tricked.is-a.dev</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <TopNav />
      <main className={classes.root}>
        <Typography component="h1" variant="h1" className={classes.center}>
          Tricked.is-a.dev
        </Typography>
        <Typography component="h2" variant="h2" className={classes.center}>
                  ...
                  <Card>
                    <CardActionArea>
                      ...
                      <CardContent>
                        ...
                        <Typography variant="body2" color="textSecondary" component="p" style={{ minHeight: "2rem" }}>
                          {x.description}
                        </Typography>
                      </CardContent>
                    </CardActionArea>
